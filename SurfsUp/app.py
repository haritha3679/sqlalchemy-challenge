...
# Session command I have put it in each def where required and closed it within that.
  ...
  #  """List all available api routes."""
    return (
       "<div style='text-align: center; color: blue; font-family: Arial, sans-serif;'>"
        ...
        "<p>Available Routes for Climate App:</p>" 
         

        "<div style='display: flex; flex-direction: column; align-items: center;'>" 
        f"<br/><a href='/api/v1.0/precipitation'> /api/v1.0/precipitation</a><br/>"
        f"<br/><a href='/api/v1.0/stations'>/api/v1.0/stations </a> <br/>"
